...
namespace ldtk {
    ...
    class LdtkTableOfContentEntry {
         ...
         */
        std::optional<std::vector<ReferenceToAnEntityInstance>> get_instances() const { return instances; }
        void set_instances(std::optional<std::vector<ReferenceToAnEntityInstance>> value) { this->instances = value; }
    ...
    class ForcedRefs {
        ...
        public:
        std::optional<AutoLayerRuleGroup> get_auto_layer_rule_group() const { return auto_layer_rule_group; }
        void set_auto_layer_rule_group(std::optional<AutoLayerRuleGroup> value) { this->auto_layer_rule_group = value; }

        std::optional<AutoLayerRuleDefinition> get_auto_rule_def() const { return auto_rule_def; }
        void set_auto_rule_def(std::optional<AutoLayerRuleDefinition> value) { this->auto_rule_def = value; }

        std::optional<LdtkCustomCommand> get_custom_command() const { return custom_command; }
        void set_custom_command(std::optional<LdtkCustomCommand> value) { this->custom_command = value; }

        std::optional<Definitions> get_definitions() const { return definitions; }
        void set_definitions(std::optional<Definitions> value) { this->definitions = value; }

        std::optional<EntityDefinition> get_entity_def() const { return entity_def; }
        void set_entity_def(std::optional<EntityDefinition> value) { this->entity_def = value; }

        std::optional<EntityInstance> get_entity_instance() const { return entity_instance; }
        void set_entity_instance(std::optional<EntityInstance> value) { this->entity_instance = value; }

        std::optional<ReferenceToAnEntityInstance> get_entity_reference_infos() const { return entity_reference_infos; }
        void set_entity_reference_infos(std::optional<ReferenceToAnEntityInstance> value) { this->entity_reference_infos = value; }

        std::optional<EnumDefinition> get_enum_def() const { return enum_def; }
        void set_enum_def(std::optional<EnumDefinition> value) { this->enum_def = value; }

        std::optional<EnumValueDefinition> get_enum_def_values() const { return enum_def_values; }
        void set_enum_def_values(std::optional<EnumValueDefinition> value) { this->enum_def_values = value; }

        std::optional<EnumTagValue> get_enum_tag_value() const { return enum_tag_value; }
        void set_enum_tag_value(std::optional<EnumTagValue> value) { this->enum_tag_value = value; }

        std::optional<FieldDefinition> get_field_def() const { return field_def; }
        void set_field_def(std::optional<FieldDefinition> value) { this->field_def = value; }

        std::optional<FieldInstance> get_field_instance() const { return field_instance; }
        void set_field_instance(std::optional<FieldInstance> value) { this->field_instance = value; }

        std::optional<GridPoint> get_grid_point() const { return grid_point; }
        void set_grid_point(std::optional<GridPoint> value) { this->grid_point = value; }

        std::optional<IntGridValueDefinition> get_int_grid_value_def() const { return int_grid_value_def; }
        void set_int_grid_value_def(std::optional<IntGridValueDefinition> value) { this->int_grid_value_def = value; }

        std::optional<IntGridValueGroupDefinition> get_int_grid_value_group_def() const { return int_grid_value_group_def; }
        void set_int_grid_value_group_def(std::optional<IntGridValueGroupDefinition> value) { this->int_grid_value_group_def = value; }

        std::optional<IntGridValueInstance> get_int_grid_value_instance() const { return int_grid_value_instance; }
        void set_int_grid_value_instance(std::optional<IntGridValueInstance> value) { this->int_grid_value_instance = value; }

        std::optional<LayerDefinition> get_layer_def() const { return layer_def; }
        void set_layer_def(std::optional<LayerDefinition> value) { this->layer_def = value; }

        std::optional<LayerInstance> get_layer_instance() const { return layer_instance; }
        void set_layer_instance(std::optional<LayerInstance> value) { this->layer_instance = value; }

        std::optional<Level> get_level() const { return level; }
        void set_level(std::optional<Level> value) { this->level = value; }

        std::optional<LevelBackgroundPosition> get_level_bg_pos_infos() const { return level_bg_pos_infos; }
        void set_level_bg_pos_infos(std::optional<LevelBackgroundPosition> value) { this->level_bg_pos_infos = value; }

        std::optional<NeighbourLevel> get_neighbour_level() const { return neighbour_level; }
        void set_neighbour_level(std::optional<NeighbourLevel> value) { this->neighbour_level = value; }

        std::optional<LdtkTableOfContentEntry> get_table_of_content_entry() const { return table_of_content_entry; }
        void set_table_of_content_entry(std::optional<LdtkTableOfContentEntry> value) { this->table_of_content_entry = value; }

        std::optional<TileInstance> get_tile() const { return tile; }
        void set_tile(std::optional<TileInstance> value) { this->tile = value; }

        std::optional<TileCustomMetadata> get_tile_custom_metadata() const { return tile_custom_metadata; }
        void set_tile_custom_metadata(std::optional<TileCustomMetadata> value) { this->tile_custom_metadata = value; }

        std::optional<TilesetDefinition> get_tileset_def() const { return tileset_def; }
        void set_tileset_def(std::optional<TilesetDefinition> value) { this->tileset_def = value; }

        std::optional<TilesetRectangle> get_tileset_rect() const { return tileset_rect; }
        void set_tileset_rect(std::optional<TilesetRectangle> value) { this->tileset_rect = value; }

        std::optional<LdtkTocInstanceData> get_toc_instance_data() const { return toc_instance_data; }
        void set_toc_instance_data(std::optional<LdtkTocInstanceData> value) { this->toc_instance_data = value; }

        std::optional<World> get_world() const { return world; }
        void set_world(std::optional<World> value) { this->world = value; }
    };
    ...
    class LdtkJson {
         ...
         * Quicktype will drop types that are not explicitely used.
         */
        std::optional<ForcedRefs> get_forced_refs() const { return forced_refs; }
        void set_forced_refs(std::optional<ForcedRefs> value) { this->forced_refs = value; }
